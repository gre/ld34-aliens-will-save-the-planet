...
},{"gl-texture2d":40}],6:[function(require,module,exports){
'use strict'
...
},{"./lib/create-attributes":7,"./lib/create-uniforms":8,"./lib/reflect":9,"./lib/runtime-reflect":10,"./lib/shader-cache":11}],7:[function(require,module,exports){
'use strict'
...
},{"./reflect":9}],9:[function(require,module,exports){
'use strict'
...
},{"gl-format-compiler-error":12,"weakmap-shim":28}],12:[function(require,module,exports){
...
},{"add-line-numbers":13,"gl-constants/lookup":17,"glsl-shader-name":18,"sprintf-js":25}],13:[function(require,module,exports){
...
},{"pad-left":14}],14:[function(require,module,exports){
/*!
...
},{"repeat-string":15}],15:[function(require,module,exports){
/*!
...
},{"atob-lite":19,"glsl-tokenizer":24}],19:[function(require,module,exports){
...
},{"./lib/builtins":21,"./lib/literals":22,"./lib/operators":23}],21:[function(require,module,exports){
module.exports = [
    'gl_Position'
  , 'gl_PointSize'
  , 'gl_ClipVertex'
...
},{"iota-array":35,"is-buffer":36}],35:[function(require,module,exports){
"use strict"
...
},{"bit-twiddle":37,"buffer":1,"dup":38}],40:[function(require,module,exports){
'use strict'
...
},{"ndarray":34,"ndarray-ops":29,"typedarray-pool":39}],41:[function(require,module,exports){
/*!
 * numeral.js
 * version : 1.5.3
 * author : Adam Draper
...
var staticVert = "#define GLSLIFY 1\nattribute vec2 p;\nvarying vec2 uv;\n\nvoid main() {\n  gl_Position = vec4(p, 0.0, 1.0);\n  uv = (p + 1.0) / 2.0;\n}\n";
...
var gl = canvas.getContext("webgl") || canvas.getContext("experiemntal-webgl");
...
function getPixelAverage(fbo) {
  ...
  return [res[0] / 500, res[1] / 500, res[2] / 500, res[3] / 500];
}

var evtCanvasNormPosition = function evtCanvasNormPosition(e) {
  var rect = canvas.getBoundingClientRect();
  return [(e.clientX - rect.left) / width, 1 - (e.clientY - rect.top) / height];
};

var projectToMap = function projectToMap(_ref, _ref2, zoom) {
  ...
  var cx = _ref3[0];
  var cy = _ref3[1];
  return [(x + (zoom * 2 - 1) / 2) / (zoom * 2) + cx - 0.5, (y + (zoom - 1) / 2) / zoom + cy - 0.5];
};

// WAIT RESOURCES AND START THE GAME

_loader2.default.images("images/mapColor.png", "images/mapMask.png").then(function (_ref5) {
  var _ref6 = _slicedToArray(_ref5, 2);

  var mapColor = _ref6[0];
  var mapMask = _ref6[1];

  // mapColor: the color texture
  // mapMask: static data about the map: RED: ground, GREEN: fertility

  var mapColorTexture = (0, _glTexture2d2.default)(gl, mapColor);
  mapColorTexture.minFilter = mapColorTexture.magFilter = gl.LINEAR;

  var mapMaskTexture = (0, _glTexture2d2.default)(gl, mapMask);
  mapMaskTexture.minFilter = mapMaskTexture.magFilter = gl.LINEAR;

  function fbo(size) {
    var fbo = (0, _glFbo2.default)(gl, size);
    fbo.color[0].minFilter = fbo.color[0].magFilter = gl.LINEAR;
    return fbo;
  }
  ...
  var co2maps = [0, 1].map(function () {
    return fbo([1000, 500]);
  });
  var treemaps = [0, 1].map(function () {
    return fbo([1000, 500]);
  });

  var swap = function swap(_ref7) {
  ...
  // game states
  var vacuum = undefined,
      addSeed = undefined,
      bomb = undefined;
  var lastBombDropped = 0;
  var center = undefined,
      zoom = undefined;
  var factories = Object.keys(locations).sort(function () {
  ...
  var $humans = domHelper("humans");
  var $co2 = domHelper("co2");
  var $o2 = domHelper("o2");
  var $n2 = domHelper("n2");
  var $year = domHelper("year");
  var $factories = domHelper("factories");
  var $help = domHelper("help");
  function updateDOM(t) {
    $humans.setText((0, _numeral2.default)(humans).format("0,0"));
    ...
    if (t > 5000) $help.setText("Detected a human factory in " + factories[0].name);
  }

  function syncCO2stats() {
    var treesPixel = getPixelAverage(treemaps[0]);
    var co2Pixel = getPixelAverage(co2maps[0]);
    co2 = co2Pixel[0] / 256;
    o2 = co2Pixel[3] / 256;
    n2 = 1;
    var sum = co2 + o2 + n2;
  ...
  function update(t, dt) {
    center = [(0.3 + t / 34000) % 1, 0.55 + 0.2 * Math.sin(t / 2500)];
    zoom = 2;
    ...
    if (keys[KEY_CODE.V]) {
      ...
      if (t - lastBombDropped > 600) {
        (function () {
          lastBombDropped = t;
          var bombCenter = projectToMap(ePos, center, zoom);
          var bombSize = 0.01 + 0.01 * Math.random();
          bomb = {
            center: bombCenter,
            size: 0.02 + 0.02 * Math.random()
          };
          factories = factories.filter(function (_ref9) {
            var center = _ref9.center;
            return distance(bombCenter, center) > bombSize + 0.01;
          });
        })();
      }
    }
    ...
    if (vacuum) {
      ...
      Object.assign(shaders.drawRadial.uniforms, _extends({
...
},{"./loader":43,"gl-fbo":5,"gl-shader":6,"gl-texture2d":40,"numeral":41}],43:[function(require,module,exports){
"use strict";
...
var images = function images() {
  for (var _len = arguments.length, srcs = Array(_len), _key = 0; _key < _len; _key++) {
    srcs[_key] = arguments[_key];
  }

  return Promise.all(srcs.map(image));
};
